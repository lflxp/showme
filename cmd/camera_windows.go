...
// 	// camCmd.PersistentFlags().String("foo", "", "A help for foo")

// 	// Cobra supports local flags which will only run when this command
// 	// is called directly, e.g.:
// 	// camCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
// 	camCmd.Flags().StringVarP(&cam_d, "device", "d", "", "摄像头设备 eg. /dev/video0")
// 	camCmd.Flags().StringVarP(&cam_f, "fmtstr", "f", "", "video format to use, default first supported")
// 	camCmd.Flags().StringVarP(&cam_s, "szstr", "s", "", "frame size to use, default largest one")
// 	camCmd.Flags().StringVarP(&cam_l, "address", "l", ":8080", "addr to listien")
// 	camCmd.Flags().BoolVarP(&cam_p, "fps", "p", false, "print fps info")
// 	camCmd.Flags().BoolVarP(&cam_m, "single", "m", false, "single image http mode, default mjpeg video")
// }
