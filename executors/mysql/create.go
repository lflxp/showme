...
func (this *basic) CreateCom(interval int, before *basic) string {
	...
	data_detail += utils.Colorize(strings.Repeat(" ", 6-len(strconv.Itoa(update_diff)))+strconv.Itoa(update_diff), "", "", false, false)
	data_detail += utils.Colorize(strings.Repeat(" ", 6-len(strconv.Itoa(delete_diff)))+strconv.Itoa(delete_diff), "", "", false, false)
	data_detail += utils.Colorize(strings.Repeat(" ", 7-len(strconv.Itoa(select_diff)))+strconv.Itoa(select_diff), "yellow", "", false, false)
	data_detail += utils.Colorize(strings.Repeat(" ", 6-len(strconv.Itoa(tps)))+strconv.Itoa(tps), "yellow", "", false, false)
